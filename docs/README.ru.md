...
Environment discovery сначала ищет установку HOI4 через Steam metadata, затем при необходимости сканирует folders и читает `launcher-settings.json` для document data path и версии игры.
